...
public class RandomElementCollection implements java.io.Serializable {
    ...
    public int getIndexOfElement (RandomElement randomElement) {
    	return listElements.indexOf(randomElement);
    }
    ...
    //Whether to display this collection as image or text
    //Display the collection as image if one of the elements is image
    public boolean isImageBased () {
    	for (RandomElement element:listElements) {
    		if (element.isImageBased())
    			return true;
    	}
    	return false;
    }
    ...
    public ArrayList <String> getListImageToDisplay () {
    	ArrayList <String> result = new ArrayList<String>();
    	for (RandomElement element:listElements) {
    		if (element.isImageBased())
    			result.add(element.getImageName());
    	}    	
    	return result;
    }
    
    public ArrayList <String> getListTextToDisplay () {
    	ArrayList <String> result = new ArrayList<String>();
    	for (RandomElement element:listElements) {
