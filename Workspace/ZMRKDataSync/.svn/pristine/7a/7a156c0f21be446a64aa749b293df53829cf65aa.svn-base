			...
			if (listEntity != null && listEntity.size() == 1)
			{
				...
				for (Map.Entry<String, Object> entry: entityAttributes.entrySet())
				{
					...
					try
					{
						...
						if (success == false)
						{
							ZMRKLog.e (LOGTAG, "Cannot create entity " + entityName + " with attribute " + attributeName + " with value " + attributeValue);
							return null;
						}
					}
					catch (Exception e)
